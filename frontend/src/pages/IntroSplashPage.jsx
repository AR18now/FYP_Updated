  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-r2d-primaryDark flex items-center justify-center px-4 py-10 sm:py-12">
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col lg:flex-row gap-8 lg:gap-10 lg:items-stretch">
        {/* Left: app flow */}
        <section className="flex-1 rounded-2xl border border-r2d-primary/35 bg-slate-900/50 backdrop-blur-md p-6 sm:p-8 shadow-xl shadow-blue-950/40">
          ...
          <ol className="mt-6 space-y-4">
            {FLOW_STEPS.map(({ step, title, body, icon: Icon }) => (
              ...
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-r2d-primary/30 text-blue-100 ring-1 ring-r2d-primaryLight/35">
        ...
        {/* Right: brand + start */}
        <div className="w-full lg:max-w-md shrink-0 rounded-2xl border border-r2d-primary/35 bg-slate-900/60 backdrop-blur-md p-8 shadow-2xl shadow-blue-950/50 flex flex-col items-center text-center">
