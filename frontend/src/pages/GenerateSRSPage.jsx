  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-6xl mx-auto">
      <section className="rounded-2xl border border-r2d-border bg-r2d-surfaceElevated shadow-card dark:bg-slate-900/85 dark:border-slate-700 overflow-hidden">
        <div className="px-6 py-5 lg:px-8 lg:py-6 flex flex-wrap items-start gap-4 border-b border-r2d-border/80 dark:border-slate-700/80 bg-gradient-to-r from-slate-50 to-white dark:from-slate-900 dark:to-slate-900/50">
