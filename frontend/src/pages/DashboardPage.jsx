      ...
      <section aria-labelledby="other-heading">
        ...
        <ul className="flex flex-wrap gap-2">
          <li>
            <Link
              to="/history"
              className="inline-flex items-center gap-2 rounded-lg border border-r2d-border px-3 py-2 text-xs font-medium text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
            >
