...
function AuthorPortalArt({ className }) {
  return (
    <svg className={className} viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <rect x="24" y="20" width="120" height="150" rx="10" fill="currentColor" className="text-blue-100 dark:text-blue-950/50" />
      <rect
        x="44"
        y="8"
        width="120"
      ...
      />
      <path d="M60 40h88M60 58h72M60 76h88M60 94h56" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" className="text-blue-400/50 dark:text-blue-500/35" />
  ...
  return (
    <svg className={className} viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <rect
        ...
        rx="8"
        strokeWidth="3"
        className="stroke-indigo-600/65 fill-indigo-50/95 dark:stroke-indigo-400/45 dark:fill-indigo-950/45"
      />
      <rect x="64" y="32" width="72" height="8" rx="2" className="fill-indigo-200/85 dark:fill-indigo-800/45" />
      <rect x="64" y="48" width="56" height="8" rx="2" className="fill-indigo-200/65 dark:fill-indigo-800/35" />
      ...
      <path d="M64 112h48" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="text-indigo-700/35 dark:text-indigo-500/35" />
...
const WelcomePage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -bottom-24 -right-16 h-72 w-72 rounded-full bg-indigo-500/12 blur-3xl" />
      <button
        type="button"
        onClick={toggleTheme}
      ...
      <div className="w-full max-w-6xl space-y-10 animate-fade-in">
        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch gap-6 lg:gap-0 lg:rounded-3xl lg:overflow-hidden lg:shadow-2xl lg:border lg:border-r2d-border dark:lg:border-slate-700">
          ...
          <section className="relative flex-1 flex flex-col md:flex-row md:items-stretch gap-6 rounded-3xl border-2 border-r2d-primary/30 dark:border-r2d-primary/45 bg-gradient-to-br from-blue-50/95 via-white to-white dark:from-blue-950/25 dark:via-slate-900 dark:to-slate-900 shadow-xl lg:rounded-none lg:border-0 lg:shadow-none p-6 md:p-8 lg:pr-4">
            ...
            <div className="relative md:order-1 md:flex-1 flex flex-col min-w-0">
              <span className="inline-flex items-center gap-1.5 self-start rounded-full bg-r2d-primary/10 text-r2d-primary dark:text-blue-300 px-3 py-1 text-xs font-bold uppercase tracking-wide border border-r2d-primary/25">
              ...
              <p className="text-xs font-medium text-r2d-primary/90 dark:text-blue-300/90">Author workspace · SRS, diagrams, RTM</p>
              ...
              <p className="mt-5 text-xs font-semibold uppercase tracking-wide text-r2d-primary/85 dark:text-blue-400/85">
                Typical flow
              </p>
              <ul className="mt-2 space-y-2 text-xs text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-3.5 w-3.5 text-r2d-primary shrink-0 mt-0.5 dark:text-blue-400" aria-hidden />
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <Link
                  to="/signup/user"
                  className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-r2d-primary/40 bg-white/80 dark:bg-slate-800/80 px-4 py-3 text-sm font-semibold text-r2d-primary dark:text-blue-100 hover:bg-blue-50 dark:hover:bg-slate-700 transition-colors"
                >
          ...
          <div
            className="hidden lg:flex flex-col w-[min(7rem,8vw)] shrink-0 items-center justify-center gap-3 bg-gradient-to-b from-slate-100 via-slate-50 to-blue-50/50 dark:from-slate-800 dark:via-slate-800 dark:to-indigo-950/25 border-x border-slate-200/80 dark:border-slate-700 px-2 text-center"
            role="separator"
            aria-label="Choose exactly one portal"
          >
            <span className="w-px flex-1 min-h-[3rem] max-h-24 bg-gradient-to-b from-blue-400/0 via-slate-300 dark:via-slate-600 to-indigo-400/0" />
          ...
          {/* Expert lane */}
          <section className="relative flex-1 flex flex-col md:flex-row md:items-stretch gap-6 rounded-3xl border-2 border-indigo-400/45 dark:border-indigo-500/40 bg-gradient-to-br from-slate-50 via-indigo-50/40 to-white dark:from-indigo-950/20 dark:via-slate-900 dark:to-slate-900 shadow-xl lg:rounded-none lg:border-0 lg:shadow-none p-6 md:p-8 lg:pl-4 ring-1 ring-indigo-200/40 dark:ring-indigo-900/35">
            <div className="absolute top-4 right-4 md:static md:order-2 md:flex md:items-center md:justify-center md:w-[42%] shrink-0">
              <ReviewerPortalArt className="w-full max-w-[200px] mx-auto md:max-w-none h-auto opacity-95" />
            </div>
            <div className="relative md:order-1 md:flex-1 flex flex-col min-w-0">
              <span className="inline-flex items-center gap-1.5 self-start rounded-full bg-indigo-100/90 text-indigo-900 dark:bg-indigo-950/50 dark:text-indigo-200 px-3 py-1 text-xs font-bold uppercase tracking-wide border border-indigo-300/50 dark:border-indigo-600/40">
                <UserCheck className="h-3.5 w-3.5" aria-hidden />
                I review submissions
              </span>
              <div className="mt-4 inline-flex rounded-xl bg-gradient-to-br from-indigo-800 to-r2d-primaryDark p-3 w-fit text-white shadow-md">
              ...
              <p className="text-xs font-medium text-indigo-900/85 dark:text-indigo-300/90">Reviewer panel · queue only</p>
              <p className="mt-3 text-sm text-slate-600 dark:text-slate-400 flex-1 leading-relaxed">
              ...
              <p className="mt-5 text-xs font-semibold uppercase tracking-wide text-indigo-900/75 dark:text-indigo-400/80">
                Typical flow
              </p>
              <ul className="mt-2 space-y-2 text-xs text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-3.5 w-3.5 text-indigo-600 shrink-0 mt-0.5 dark:text-indigo-400" aria-hidden />
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Link
                  to="/login/expert"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-r2d-primaryDark text-white px-4 py-3 text-sm font-semibold hover:bg-indigo-950 dark:hover:bg-indigo-700 transition-colors shadow-sm"
                >
                  <LogIn className="h-4 w-4" />
                  Expert sign in
                </Link>
                <Link
                  to="/signup/expert"
                  className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-indigo-600/35 dark:border-indigo-500/45 bg-white/90 dark:bg-slate-800/90 px-4 py-3 text-sm font-semibold text-indigo-950 dark:text-indigo-100 hover:bg-indigo-50 dark:hover:bg-slate-700 transition-colors"
                >
                  <UserPlus className="h-4 w-4" />
                  New expert account
                </Link>
        ...
        <p className="text-center text-xs text-slate-500 dark:text-slate-500 max-w-xl mx-auto leading-relaxed">
          ...
          If you are writing your own SRS, stay on the <strong className="font-semibold text-r2d-primary dark:text-blue-400">user</strong> side. If you only review
          others&apos; work, use the <strong className="font-semibold text-indigo-800 dark:text-indigo-400">expert</strong> side — credentials do not carry across.
        </p>
      </div>
    </div>
  );
